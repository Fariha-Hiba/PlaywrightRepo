...
- Name: radio button count 1
- Location: C:\PlaywrightTrainingAscendion\tests\RadioButtonCount.spec.js:3:5
...
Call log:
  - navigating to "https://testautomationpractice.blogspot.com/#", waiting until "load"
    ...
    at C:\PlaywrightTrainingAscendion\tests\RadioButtonCount.spec.js:4:16
```
