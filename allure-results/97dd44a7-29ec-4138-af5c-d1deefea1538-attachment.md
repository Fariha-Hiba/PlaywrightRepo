...
- Name: Checking Browser URL
- Location: C:\PlaywrightTrainingAscendion\tests\00_HomePage.spec.js:14:1
...
Call log:
  - navigating to "https://www.hollandandbarrett.com/", waiting until "load"
    ...
    at C:\PlaywrightTrainingAscendion\tests\00_HomePage.spec.js:15:16
```
...
> 15 |     await page.goto('https://www.hollandandbarrett.com/')
     |                ^ Error: page.goto: Test timeout of 30000ms exceeded.
  16 |     const pageURL = await page.url()
  17 |     console.log('Page URL is ..... : ', pageURL)
  18 |
  19 |     //Assertions
  20 |     await expect(page).toHaveURL('https://www.hollandandbarrett.com/')
  21 |     await page.close();
  22 | })
```